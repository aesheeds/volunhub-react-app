...
## What I Learned
Building VolunHub with Claude has changed the way I think about the development process as a whole. Rather than getting stuck with setup details or syntax, I could focus on what the app should do. I feel like this has expanded my creativity, opening myself up to many opportunities with this project. It's best to use an AI tool as a collaborative partner, it handles genrating boilerplate, scaffold components, and write helpers, while I drive that "what and "why" of the project. I still needed to understand what was happening, as that is how I could make sure mistakes weren't being made, but this has made making a full stack projects faster and easier! Working on Volunhub slowly, working with claude in sections, and knowing what I wanted to have in this app from the start has made the process of building this projects so smooth. At times, Claude would give me bad suggestions or buggy code, but by using the methods taught in class, I was able to get through these small bumps and create an fully built app! 